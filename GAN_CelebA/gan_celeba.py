...
def make_generator_model():
    ...
    generator = tf.keras.Sequential([
        ...
        Conv2DTranspose(4*base_num_filters, (5, 5), strides=(4, 4)),
        BatchNormalization(),
        LeakyReLU(),
        
        Cropping2D(((0, 0), (0, 1))),

        Conv2DTranspose(3*base_num_filters, (5, 5), strides=(2, 2)),
        BatchNormalization(),
        LeakyReLU(),
        
        Cropping2D(((0, 1), (0, 1))),
        
        Conv2DTranspose(2*base_num_filters, (3, 3), strides=(2, 2)),
        BatchNormalization(),
        LeakyReLU(),
        
        Cropping2D(((0, 1), (0, 1))),
        
        Conv2DTranspose(base_num_filters, (3, 3), strides=(2, 2)),
        BatchNormalization(),
        LeakyReLU(),

        Conv2DTranspose(3, (3, 3), strides=(1, 1),
...
class GAN_CELEBA(tf.keras.Model):
    ...
    def generate_images(self, input_noise_dim):
        return self.generator(input_noise_dim, training=False)
